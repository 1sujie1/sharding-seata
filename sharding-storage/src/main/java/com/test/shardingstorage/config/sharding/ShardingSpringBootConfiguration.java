...
// */
//package com.test.shardingstorage.config.sharding;
//
...
//                SpringBootEncryptRuleConfigurationProperties.class, SpringBootPropertiesConfigurationProperties.class})
...
//        return null == standardEnv.getProperty(prefix + "name") ? new InlineExpressionParser(
//                standardEnv.getProperty(prefix + "names")).splitAndEvaluate() : Collections.singletonList(
//                standardEnv.getProperty(prefix + "name"));
//    }
//
...
//                DataSourceUtil.getDataSource(dataSourceProps.get("type").toString(), dataSourceProps));
//    }
//
